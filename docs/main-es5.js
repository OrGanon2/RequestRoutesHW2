...
var CatsComponent = /** @class */ (function () {
    function CatsComponent(photo2) {
        var _this = this;
        this.photo2 = photo2;
        this.photos2 = [];
        this.photo2.getPhotos2().subscribe(function (somePhoto) {
            _this.photos2 = somePhoto;
        });
    }
    CatsComponent.prototype.ngOnInit = function () {
    };
    CatsComponent.ctorParameters = function () { return [
...
var DogsComponent = /** @class */ (function () {
    function DogsComponent(photo) {
        var _this = this;
        this.photo = photo;
        this.photos = [];
        this.photo.getPhotos().subscribe(function (somephoto) {
            _this.photos = somephoto;
        });
    }
    DogsComponent.prototype.ngOnInit = function () {
    };
    DogsComponent.ctorParameters = function () { return [
        { type: src_app_services_imgs_service__WEBPACK_IMPORTED_MODULE_2__["ImgsService"] }
    ]; };
...
var FoxsComponent = /** @class */ (function () {
    function FoxsComponent(photo3) {
        var _this = this;
        this.photo3 = photo3;
        this.photos3 = [];
        this.photo3.getPhotos3().subscribe(function (somePhoto) {
            _this.photos3 = somePhoto;
        });
    }
    FoxsComponent.prototype.ngOnInit = function () {
    };
    FoxsComponent.ctorParameters = function () { return [
        { type: src_app_services_imgs_service__WEBPACK_IMPORTED_MODULE_2__["ImgsService"] }
    ]; };
...
var ImgsService = /** @class */ (function () {
    function ImgsService(clientimg) {
        this.clientimg = clientimg;
    }
    ImgsService.prototype.getPhotos = function () {
        return this.clientimg.get("https://dog.ceo/api/breeds/image/random");
    };
    ;
    ImgsService.prototype.getPhotos2 = function () {
        return this.clientimg.get("https://cat-fact.herokuapp.com/facts");
    };
    ;
    ImgsService.prototype.getPhotos3 = function () {
        return this.clientimg.get("https://randomfox.ca/floof/?ref=apilist.fun");
    };
    ImgsService.ctorParameters = function () { return [
